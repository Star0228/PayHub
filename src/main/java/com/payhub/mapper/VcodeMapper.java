...
public interface VcodeMapper {
     ...
     */
    @Insert("INSERT INTO verification_codes (code, email, type, created_at, expires_at, used) " +
            "VALUES (#{code}, #{email}, #{type}, #{createdAt}, #{expiresAt}, #{used})")
     ...
     */
    @Select("SELECT id, code, email, type, created_at, expires_at, used, account_id " + // 明确列出字段是个好习惯
